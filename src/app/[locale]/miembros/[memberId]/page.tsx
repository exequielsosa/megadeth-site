...
export async function generateMetadata({
  ...
  const biography =
    member.biography[locale as "es" | "en"] || member.biography.es;
          ...
          <Card sx={{ height: "100%" }}>
            <CardContent>
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Typography variant="body1">{member.birthYear}</Typography>
              </Box>
              ...
              {"deathYear" in member && member.deathYear && (
                <Box sx={{ mb: 2 }}>
                  ...
                  <Typography variant="body1">{member.deathYear}</Typography>
                </Box>
              )}
